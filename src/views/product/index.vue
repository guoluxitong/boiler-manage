<template>
  <div style="margin-top: 20px" class="app-container product-container">
    <div v-if="PartCategory==0">
      ...
      >
      <el-table-column  align="center" label="实景观看">
          <template slot-scope="scope">
            <el-tooltip :disabled="isShowTooltip" content="摄像头" placement="top" effect="dark" >
              <el-button
                         circle
     ...
     <menu-context-item @click="handleMonitor" :width="100" :fontSize="14">监控</menu-context-item>
    ...
    <div v-if="PartCategory==3">
      ...
      <el-dialog :title="titleName1" :visible.sync="dialogFormVisible">
        <el-form
          :rules="rules"
          ref="boilerModelForm"
