        ...
        <el-row>
          <el-col :span="24">
            ...
            <!--  <el-input v-model="boilerCustomerFormData.province"></el-input>-->
              <v-distpicker :province="boilerCustomerFormData.province" :city="boilerCustomerFormData.city" :area="boilerCustomerFormData.district"  @province="onChangeProvince" @city="onChangeCity"@area="onChangearea" >
              </v-distpicker>
            </el-form-item>
          </el-col>
         <!-- <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onChangeProvince(data) {
      this.boilerCustomerFormData.province = data.value
    },
    onChangeCity(data) {
      this.boilerCustomerFormData.city = data.value
    },
    onChangearea(data) {
      this.boilerCustomerFormData.district = data.value
    },
    getListByName() {
